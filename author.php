...
<header class="archive-header">
	...
	<?php	
	$blog_title_bcktoggle	= apply_filters( "olea_options", "blog_author_title_bcktoggle", 1 );
	$blog_title_backimg		= apply_filters( "olea_options", "blog_author_title_backimg",get_template_directory_uri(). '/img/default/header-author.jpg' );
	...
	<div class="row">
		...
		printf( __( '<small>Author Archives:</small> %s', 'olea' ), '<span class="vcard">' . get_the_author() . '</span>' );
		endif;
		?>
		</h1>
