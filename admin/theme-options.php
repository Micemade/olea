...
// HEADINGS DECOR BACKIMAGES -  FILES READER
$head_decor_path = get_template_directory() . '/img/head_decor/'; 
$head_decor_url = get_template_directory_uri().'/img/head_decor/'; 
$head_decor = array(); 

if ( is_dir($head_decor_path) ) {
    if ($head_decor_dir = opendir($head_decor_path) ) { 
        while ( ($head_decor_file = readdir($head_decor_dir)) !== false ) {
            if(stristr($head_decor_file, ".png") !== false || stristr($head_decor_file, ".jpg") !== false ) {
                $head_decor[] = $head_decor_url . $head_decor_file;
            }
        }    
    }
}
...
$of_options[] = array(
					"name"			=> "Custom Favicon",
					"desc_html"		=> "Custom favicon is discarded in favour of <a href=\"customize.php\"> Customizer > Site identity > Site icon</a>",
					"id"			=> "custom_favicon_discarded",
...
$of_options[] = array(
					...
					"std"			=> array('face'=>'Crushed', 'weight'=>'400', 'color'=>''),
					"type"			=> "select_google_font",
					"preview"		=> array(
									"text" => "Preview of the title.", //this is the text from preview box
...
$of_options[] = array( 
					...
					"fold"			=> "google",
					"unfold"		=> "google_typekit_toggle",/* the radio hook for hide */
					"std"			=> array('face'=>'Roboto', 'size'=>'16px', 'weight'=>'400', 'color'=>'#333333'),
					"type"			=> "select_google_font",
					"preview"		=> array(
...
$of_options[] = array(
					"name"			=> "",
					"desc_html"		=> 'Enter the Typekit ID - find your Typekit ID on <strong><a href="http://typekit.com">typekit.com</a></strong> under Kit Editor -> Embed Code. olea theme uses two main fonts grouped for usage in following css selectors:'.
...
$of_options[] = array(
					...
					"desc"			=> "NOTE: not all fonts support all subsets",
					"id"			=> "google_subsets",
...
$of_options[] = array(
					"name"			=> "Use headings decorative tiles ?",
					"desc"			=> "",
					"id"			=> "head_decor_toggle",
					"std"			=> "tiles",
					"type"			=> "radio",
					"options"		=> array(
...
$of_options[] = array(
					"name"			=> "Decorative tiles selection",
					"desc"			=> "Select tile pattern decoration for headings. Tile pattern can only have fixed back position.<br /><br /><strong>NOTE: The 'Clear img' pattern is completely transparent, so, for no background tile, select this one.</strong>",
					"id"			=> "head_decor",
					"fold"			=> "tiles", /* the radio hook for show */
					"unfold"		=> "head_decor_toggle",/* the radio hook for hide */
					"std"			=> "",
					"type"			=> "tiles",
					"options"		=> $head_decor,
					);
...
$of_options[] = array(
					"name"			=> "Decorative tiles opacity",
					"desc"			=> "",
					"id"			=> "head_decor_opacity",
					"std"			=> "30",
					"min"			=> "0",
					"step"			=> "10",
					"max"			=> "100",
...
$of_options[] = array(
					"name"			=> "",
					"desc_html"		=> '<h4>COLOR SETTINGS</h4>',
					"id"			=> "css_colors_note",
					"std"			=> '',
					"type"			=> "html"
					); 
...
$of_options[] = array(
					"name"			=> "",
					"desc_html"		=> '<h4>LINKS</h4><p><strong>These are color settings ONLY for links. For general font color, go to "Fonts" section (menu on the left)</strong></p>',
					"id"			=> "link",
					"std"			=> '',
					"type"			=> "html"
					); 
...
$of_options[] = array(
					"name"			=> "",
					"desc_html"		=> '<h4>BUTTONS:</h4><p><strong>Color settings for buttons (submits, sends ...) - background and font colors</strong></p>',
					"id"			=> "buttons",
					"std"			=> '',
					"type"			=> "html"
					); 	
...
$of_options[] = array(
					"name"			=> "Site background image - tiles or uploaded images ?",
...
$of_options[] = array(
					"name"			=> "Site background image - tiles",
...
$of_options[] = array(
					"name"			=> "Site background image - upload your  image",
...
$of_options[] = array(
					"name"			=> "Site background image - controls ",
...
$of_options[] = array(
					"name"			=> "Body background image - tiles or uploaded images ?",
					"desc"			=> "Select if you want to use our selection of background tile images, or if you want to upload your own.",
					"id"			=> "body_bg_toggle",
					"std"			=> "none",
					"type"			=> "radio",
...
$of_options[] = array(
					"name"			=> "Body background image - tiles",
...
$of_options[] = array(
					"name"			=> "Body background image - upload your  image",
...
$of_options[] = array(
					"name"			=> "Body background image - controls ",
					"desc"			=> "<b>If you uploaded your own background image</b>, select how do you want your uploaded image to repeat or if you want to repeat image at all.",
					"id"			=> "body_bg_controls",
					"std" => array(
							//'color'			=> '',
