...
function as_filter_cats_func( $atts, $content = null ) { 
	...
	if( $tax_terms && $tax_menu_style != 'none') {
		...
		echo $tax_menu_style == 'dropdown' ?'<div class="menu-toggler block-tax-toggler '. esc_attr($tax_menu_align) .'"><a href="#" title="'.esc_attr__('Toggle categories','olea').'"><span class="icon-menu"></span></a></div>' : null;
		...
		$terms_menu .= '<li class="all category-link"><a href="#" class="active"><div class="term">'. esc_attr__('All','olea') .'</div></a></li>';
		...
		echo html_entity_decode(  $terms_menu , ENT_HTML5 , 'UTF-8' );
	...
	<?php }; ?>
		...
		<div id="filter-post-<?php echo esc_attr($block_id); ?>" class="content-block cb-3">
