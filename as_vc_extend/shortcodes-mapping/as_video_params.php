<?php
add_action( 'vc_before_init', 'map_as_video' );
function map_as_video() {
	vc_map( array(
		"name" => __("Video player","olea"),
		"base" => "as_video",
		"class" => "",
		"weight"=> 1,
		'icon' =>'as_video',
		...
		"params" => array(
			...
			array(
				"type" => "dropdown",
				"class" => "",
				"heading" => __("Video hosting site",'olea'),
				"param_name" => "site",
				"value" => array(
					'Youtube'		=> 'youtube',
					'Vimeo'			=> 'vimeo',
			...
			array(
				"type" => "textfield",
				"class" => "",
				"heading" => __('Video ID','olea'),
				"param_name" => "id",
				"value" => '',
				"description" => __('Copy only video ID here, not the whole address','olea'),
				"admin_label" => true,
				"edit_field_class"=> "vc_col-sm-6"
			),
			array(
