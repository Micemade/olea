...
$custom_login = apply_filters( "olea_options", "custom_login_page", 1 );

if( $custom_login ) {

	$s_url		= get_stylesheet_directory();
	$logo		= apply_filters( "olea_options", "site_logo", $s_url.'/img/logo.png' );
	$loginback	= apply_filters( "olea_options", "admin_back_image", $s_url.'/img/loginback.png' );
	...
	echo html_entity_decode( $theme_custom_login , ENT_QUOTES, 'UTF-8' );
}
?>