...
$single_full_width			= apply_filters( "olea_options", "single_full_width", 0 );
/**
 * DISCARDED:
...
<header class="page-header">
	...
	<?php	
	$shop_title_bcktoggle	= apply_filters( "olea_options", "shop_title_bcktoggle", 1 ); // if bckimg is set to true
	$shop_title_backimg		= apply_filters( "olea_options", "shop_title_backimg", get_template_directory_uri(). '/img/default/header-shop.jpg' ); // general blog bckimg
