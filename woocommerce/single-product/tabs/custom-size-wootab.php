...
/**
 * Size Tabs for Custom Specifications Display. Compatible with WooCommerce 2.0+ only!
...
?>
	<li class="custom_tab3"><a href="#custom_tab_data3"> <?php _e('Custom tab', 'olea'); ?></a></li>
<?php
}
...
?>
	<div id="custom_tab_data3" class="panel woocommerce_options_panel">
		<div class="options_group">
			<p class="form-field">
				<?php woocommerce_wp_checkbox( array( 'id' => 'custom_tab_enabled_spec', 'label' => __('Enable Custom Tab?', 'olea'), 'description' => __('Enable this option to enable the custom tab on the frontend.', 'olea') ) ); ?>
			</p>
		</div>
		
		<div class="options_group custom_tab_options">                								
			<p class="form-field">
				<label><?php _e('Custom Tab Title:', 'olea'); ?></label>
				<input type="text" size="5" name="custom_tab_title_spec" value="<?php echo @$custom_tab_options_spec['titlec']; ?>" placeholder="<?php _e('Enter your custom tab title', 'olea'); ?>" />
			</p>
			
			<p class="form-field">
				<?php _e('Custom Tab Content:', 'olea'); ?>
           	</p>
...
add_action('woocommerce_product_data_panels', 'custom_tab_options_spec');
 ...
 * Display Tab
 * 
 * Display Size Tab on Frontend of Website for WooCommerce 2.0
 */
