...
?>
<p class="woocommerce-info no-products-found"><?php esc_html_e( 'No products were found matching your selection.', 'olea' ); ?></p>

<h3><?php esc_html_e("Perhaps you would be interested in our product on sale: ","olea")?></h3>
