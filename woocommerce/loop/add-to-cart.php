...
echo apply_filters( 'woocommerce_loop_add_to_cart_link',
	sprintf( '<div class="add-to-cart-holder"><a rel="nofollow" href="%s" data-quantity="%s" data-product_id="%s" data-product_sku="%s" class="tip-top %s" title="%s" data-tooltip><span class="icon-shopping63"></span></a></div>',
