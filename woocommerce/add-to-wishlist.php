...
$title_added		= __( 'Product added! Browse Wishlist','olea' );
$title_in_wishlist	= __( 'The product is already in the wishlist! Browse Wishlist','olea' );
...
<div class="yith-wcwl-add-to-wishlist add-to-wishlist-<?php echo esc_attr($product_id); ?>">
    ...
    <div class="yith-wcwl-wishlistaddedbrowse hide" style="display:none;">
		...
		<a href="<?php echo esc_url( $wishlist_url ); ?>" class="tip-top" title="<?php echo esc_attr($title_added); ?>" data-tooltip><?php echo wp_kses_post($icon_added); ?></a>
    ...
    <div class="yith-wcwl-wishlistexistsbrowse <?php echo ( $exists && ! $available_multi_wishlist ) ? 'show' : 'hide' ?>" style="display:<?php echo ( $exists && ! $available_multi_wishlist ) ? 'block' : 'none' ?>">
		...
		<a href="<?php echo esc_url( $wishlist_url ) ?>" class="tip-top" title="'<?php echo esc_attr($title_in_wishlist); ?> " data-tooltip><?php echo wp_kses_post($icon_added); ?></a>
