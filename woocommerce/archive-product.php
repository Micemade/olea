...
$products_full_width		= apply_filters( "olea_options", "products_full_width", 1 );
//
?>
...
<div class="row">
	...
	<div id="primary" class="large-<?php echo ( $layout =='full_width' || $products_full_width ) ? '12' : '8'; ?> <?php echo $layout ? esc_attr( $layout ) : null; ?> medium-12 small-12 wc-catalog-page" role="main">
		
		<?php if ( have_posts() ) : ?>

			<?php woocommerce_product_subcategories(array('before'=>'<div class="categories-title-holder"><h2 class="categories-title block-title ">'.__('Product categories','olea').'</h2></div><div class="product-categories ">', 'after'=>'<div class="clearfix" style="margin: 0 0.9375rem"></div></div>', 'force_display'=> true)); ?>
		...
		if ( is_active_sidebar( 'product-filters-widgets' ) ) {
			...
			echo '<h4 class="product-filters-title">'. __('Product filters','olea') .'</h4>';
		...
		<div class="table-grid-wrap">
			<div class="before-wc-loop-wrap border-bottom clearfix">
				<?php
