...
class as_SocialWidget extends WP_Widget {
	...
	function __construct() {
		//Settings
		$widget_ops = array('classname'=>'as_socialwidget','description'=>__('Display social icons on your site.','olea'));
		
		//Controll settings
		$control_ops = array('id_base' => 'as_socialwidget');
		
		//Create widget
		parent::__construct('as_socialwidget',__('Social Widget','olea'),$widget_ops,$control_ops);
	...
	?>
		<!-- TITLE -->
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php echo esc_html__('Title:','olea'); ?></label>
			<br />
			<input type="text" id="<?php echo esc_attr($this->get_field_id('title')); ?>" name="<?php echo esc_attr($this->get_field_name('title')); ?>" value="<?php echo esc_attr($instance['title']); ?>" class="widefat" />
		</p>		
		<!-- RSS -->
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('rss')); ?>"><?php echo esc_html__('RSS link:','olea'); ?></label>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="radio" id="<?php echo esc_attr($this->get_field_id('rss')); ?>" name="<?php echo esc_attr($this->get_field_name('rss')); ?>" <?php if($instance['rss'] == 1): ?> checked="checked" <?php endif; ?> value="1" /> <?php echo esc_html__('Yes','olea'); ?>
			&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="radio" id="<?php echo esc_attr($this->get_field_id('rss')); ?>" name="<?php echo esc_attr($this->get_field_name('rss')); ?>" <?php if($instance['rss'] == 0): ?> checked="checked" <?php endif; ?> value="0" /> <?php echo esc_html__('No','olea'); ?>
		</p>
		<!-- Facebook -->
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('facebook')); ?>"><?php esc_html_e('Facebook link:','olea'); ?></label>
			<br />
		...
		<!-- Twitter -->
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('twitter')); ?>"><?php esc_html_e('Twitter link:','olea'); ?></label>
			<br />
		...
		<!-- LinkedIn -->
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('linkedin')); ?>"><?php esc_html_e('LinkedIn link:','olea'); ?></label>
			<br />
		...
		<!-- Google Plus -->
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('gplus')); ?>"><?php esc_html_e('Google Plus link:','olea'); ?></label>
			<br />
		...
		<!-- Youtube -->
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('youtube')); ?>"><?php esc_html_e('Youtube link:','olea'); ?></label>
			<br />
		...
		<!-- Flickr -->
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('flickr')); ?>"><?php esc_html_e('Flickr link:','olea'); ?></label>
			<br />
		...
		<!-- Vimeo -->
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('vimeo')); ?>"><?php esc_html_e('Vimeo link:','olea'); ?></label>
			<br />
		...
		<!-- Pinterest -->
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('pinterest')); ?>"><?php esc_html_e('Pinterest link:','olea'); ?></label>
			<br />
		...
		<!-- Dribbble -->
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('dribbble')) ; ?>"><?php esc_html_e('Dribbble link:','olea'); ?></label>
			<br />
		...
		<!-- Forrst -->
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('forrst')); ?>"><?php esc_html_e('Forrst link:','olea'); ?></label>
			<br />
		...
		<!-- Instagram -->
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('instagram')); ?>"><?php esc_html_e('Instagram link:','olea'); ?></label>
			<br />
		...
		<!-- Github -->
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('github')); ?>"><?php esc_html_e('Github link:','olea'); ?></label>
			<br />
		...
		<!-- Picassa -->
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('picassa')); ?>"><?php esc_html_e('Picassa link:','olea'); ?></label>
			<br />
		...
		<!-- Skype -->
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('skype')); ?>"><?php esc_html_e('Skype link:','olea'); ?></label>
			<br />
