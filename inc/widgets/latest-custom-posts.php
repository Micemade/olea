...
class latest_custom_posts extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		// Widget options
		$title 	 = apply_filters('widget_title',  isset($instance['title']) ? $instance['title'] : __('Recent','olea') ); // Title		
		...
		<ul class="widget_latest_custom_posts">
			...
			<li>
				...
				<div class="widget-post-thumbs" style="<?php echo ($img_width ? 'width:'.$img_width.'px; height:auto' : '')?>">
					...
					echo $post_formats['image_output'];
					?>
	...
	function form( $instance ) {	
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('number')); ?>"><?php esc_html_e( 'Number of items for display:', 'olea' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('img_width')); ?>"><?php esc_html_e( 'Image width', 'olea' ); ?></label>
