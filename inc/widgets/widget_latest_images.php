...
class Widget_Latest_Post_Images extends WP_Widget {
	...
	function __construct() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'latest-image-widget', 'description' => __('A widget displaying latest content images.', 'olea') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'latest-content-images' );

		/* Create the widget. */
		parent::__construct( 'latest-content-images', __('Latest content images', 'olea'), $widget_ops, $control_ops );
	}
					...
					<div class="item-img">
						...
						<div class="back">
							...
							<div class="back-buttons">
								<a href="<?php echo esc_attr($link); ?>" class="tip-top" title="<?php  echo esc_attr(strip_tags(get_the_title()))  ?>"  data-tooltip><span class="icon icon-link" aria-hidden="true"></span></a>
							</div>
	...
	function form( $instance ) {
		...
		*/
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('types')); ?>"><?php esc_html_e( 'Post type(s):','olea' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'width' )); ?>"><?php esc_html_e('Image width in <b>px</b> or <b>%</b> (height is set auto):', 'olea'); ?></label>
