...
function dimox_breadcrumbs() {  
	...
	/* === OPTIONS === */  
    $text['home']     = __('Home','olea'); // text for the 'Home' link  
    $text['category'] = __('Archive by Category "%s"','olea'); // text for a category page  
    $text['search']   = __('Search Results for "%s" Query','olea'); // text for a search results page  
    $text['tag']      = __('Posts Tagged "%s"','olea'); // text for a tag page  
    $text['author']   = __('Articles Posted by %s','olea'); // text for an author page  
    $text['404']      = __('Error 404','olea'); // text for the 404 page  
