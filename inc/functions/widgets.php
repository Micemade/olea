...
//
	...
	$icons = apply_filters( "olea_options", "default_widget_icons", 1 );
	
	register_sidebar( array(
		'name'			=> __( 'Sidebar', 'olea' ),
		'id'			=> 'sidebar',
...
//	IF WOOCOMMERCE PLUGIN IS ACTIVATED, TURN ON THESE WIDGET AREAS:
	if( $olea_woo_is_active ) {
		...
		//	
		register_sidebar( array(
			'name'			=> __( 'Products page filter widgets', 'olea' ),
		...
		//	
		register_sidebar( array(
			'name'			=> __( 'Filter reset widget', 'olea' ),
...
//
	register_sidebar( array(
			'name'			=> __( 'Bottom page widgets', 'olea' ),
