...
<header class="archive-header">
	...
	<?php	
	$portfolio_title_bcktoggle	= apply_filters( "olea_options", "portfolio_title_bcktoggle", 1 );
	$portfolio_title_backimg	= apply_filters( "olea_options", "portfolio_title_backimg", get_template_directory_uri(). '/img/default/header-portfolio.jpg' );
