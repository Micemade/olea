...
<div class="row">
	...
	<div id="primary" class="large-<?php echo ( $layout =='full_width' ) ? '12' : '8'; ?> <?php echo $layout; ?> medium-12 small-12" role="main">
		...
		<?php if ( have_posts() ) : ?>
			...
			?>
				...
				<h2 class="post-title"><?php _e( 'No posts to display', 'olea' ); ?></h2>
			...
			<?php else : ?>
				...
				<h2 class="post-title"><?php _e( 'No posts found on this site', 'olea' ); ?></h2>

				<div class="post-content">
				
					<p><?php _e( 'We are sorry, but no results were found. Try search to find a related post.', 'olea' ); ?></p>
