...
<header class="page-header">
	...
	<?php	
	$single_blog_title_bcktoggle = apply_filters( "olea_options", "single_blog_title_bcktoggle", 1 );
	...
	<div class="row" style="position: relative; z-index: 6;">
		...
		<div class="small-12 table titles-holder">
			...
			$by				= __('by ','olea');
			echo '<a href="'.$author_posts.'" title="'. esc_attr(__('View all post by ','olea') .$author_name ).'" rel="author" class="author">'.$by.$author_name. '</a>';
			?>
...
<div class="row">
	...
	<div id="primary" class="large-<?php echo ($post_type == 'portfolio'|| $post_type == 'lookbook'  || $layout =='full_width') ? '12' : '8'; ?> <?php echo $layout ? esc_attr( $layout ) : null; ?> medium-12 small-12" role="main">
