...
<header id="site-menu" class="horizontal header-template-03">
	...
	<div class="row clearfix border-bottom" data-equalizer>
		...
		<div class="large-6 vertical-align">
		...
		<div class="large-6 vertical-align" style="text-align: right">
	...
	<div class="row clearfix">
		...
		<div id="site-title" class="large-12 vertical-align">
	...
	<div class="row border-top" data-equalizer>
	
		<nav id="main-nav-wrapper" class="large-9 column" data-equalizer-watch>
		...
		<div class="large-3 vertical-align" data-equalizer-watch>
